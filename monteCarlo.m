%% This function simulates the coupled channel 
function InfoPoints = monteCarlo(dist,numPoints)
if dist.num == 1
    d1 = 0;
    d2 = dist.d;
else
...
for point = 1:numPoints
    ...
    InfoPoints(point,1) = IofXandA + IofXandYgA;
    InfoPoints(point,2) = e0(point);
    fprintf('point %d out of %d points finished\n',point,numPoints)
end
